...
const Navbar = () => {
    ...
    return (
        <nav
            className="sticky top-0 z-50 bg-white  py-6 px-6 flex justify-between items-center transition-colors duration-300">
            ...
            <div className="w-full md:hidden flex items-center justify-between">
                ...
                >
                    {mobileMenuOpen ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-8" fill="none" viewBox="0 0 24 24"
                             stroke="currentColor" strokeWidth={3}>
            ...
            {mobileMenuOpen && (
                <div ref={mobileMenuRef}
                     className="absolute top-full left-0 w-full bg-white shadow-lg border-t border-lime-300 z-40 md:hidden">
                    <MobileNav
