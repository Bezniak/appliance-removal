        ...
        >
            ...
            <div className="relative z-10 flex items-center justify-center h-fit px-4">
                ...
                >
                    ...
                    <div
                        className="mt-2 md:mt-4 mb-5 md:mb-10 w-1/2 h-1 mx-auto bg-gradient-to-r from-yellow-300 to-[var(--oringe)] rounded-full shadow-md"
                        aria-hidden="true"
                    ></div>
                    <p
                        id="hero-desc"
                        className="text-white text-base md:text-xl mb-8 leading-relaxed"
                    >
