...
export const Conditions = () => {
    const conditions = [
        "Вывозим старую, сломанную и ненужную бытовую технику — бесплатно.",
    ...
    return (
        <div>
            <Seo
                title="Условия бесплатного вывоза бытовой техники в Минске"
            ...
            <FirstPageScreen
                title="Условия бесплатного вывоза бытовой техники в Минске"
                description="Узнайте, как быстро и удобно избавиться от ненужной бытовой техники бесплатно."
                    ...
                    >
                        ...
                        <div className="md:w-1/2 space-y-6 flex justify-center md:justify-start flex-col">
                            <h3 className="text-2xl text-center md:text-left md:text-3xl font-semibold text-gray-800">
                                Готовы освободить место от старой бытовой техники?
                            </h3>
