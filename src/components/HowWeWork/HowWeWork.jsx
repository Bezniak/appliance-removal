...
const steps = [
    ...
    {emoji: "🎁", text: "Услуга полностью бесплатна — никаких платежей"},
];
            ...
            <div className="container mx-auto grid md:grid-cols-2 gap-0 md:gap-16 items-center">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 max-w-lg tracking-wide" tabIndex={0}>
                        ...
                        принтеров до крупногабаритной техники. Надежно, быстро и с заботой об окружающей среде.
                    </p>
                ...
                <motion.div className="hidden md:flex justify-center">
                    <img
                        src="/many.png"
                        alt="бесплатный вывоз бытовой техники в минске"
                        className="max-w-xl w-full object-contain rounded-3xl"
                        loading="lazy"
                    />
                </motion.div>
